...
<div class="max-w-3xl mx-auto p-4">
	...
	<p>
		Lär känna alla underbara studentstyrda kommittéer som hjälper till att
		förbättra kvaliteten på din utbildning när du studerar och tillför mycket
		roligt när du inte gör det det.
	</p>
</div>
<div class="flex gap-12 p-8 max-w-5xl mx-auto flex-wrap">
	{#each committees as committee}
		<a
			href={committee.homepage}
			class="flex items-center gap-4 flex-grow justify-center"
		>
			<img
